...
export const metadata = { title: "Notes & Diary — DailyForge" };

export default function NotesDiaryLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex h-full flex-col">
      <header className="flex shrink-0 items-center gap-3 border-b border-zinc-200 bg-white px-6 py-3 dark:border-white/10 dark:bg-[#0f0f10]">
        ...
        <h1 className="text-base font-semibold text-zinc-900 dark:text-white">Notes & Diary</h1>
      </header>
