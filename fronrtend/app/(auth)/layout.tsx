...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-zinc-50 font-sans text-zinc-900 transition-colors dark:bg-[#0a0a0b] dark:text-zinc-100">
      ...
      <div className="pointer-events-none absolute top-1/2 left-1/2 h-[500px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-500/10 blur-[120px] dark:bg-indigo-500/20" />
      ...
      {/* Main Content */}
      <main className="relative z-10 p-6 sm:mx-auto sm:w-full sm:max-w-[600px]">
